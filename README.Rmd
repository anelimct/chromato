...
- [`R/`](https://github.com/anelimct/chromato/tree/main/R):
...
Launch the [`make.R`](https://github.com/anelimct/chromato/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/anelimct/chromato/blob/main/CONTRIBUTING.md).
