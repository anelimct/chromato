...
#| fig-cap: "Table de présence dans le cloud des chromato pour l'année 2025"
...
Pour l'année 2025 il manque : `r paste(unique(check_chromato_2025$missing_list), collapse = ", ")`
