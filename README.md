...
# chromato <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/anelimct/chromato/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/anelimct/chromato/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/anelimct/chromato/tree/main/R): contains R
...
Launch the
[`make.R`](https://github.com/anelimct/chromato/tree/main/make.R) file
with:
...
Guidelines](https://github.com/anelimct/chromato/blob/main/CONTRIBUTING.md).
